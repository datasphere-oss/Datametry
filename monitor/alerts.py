...
class Alert(object):
    ...
    def create_alert_from_row(alert_row: dict) -> 'Alert':
        ...
        if alert_type == 'etl_test':
            return EtlTestAlert(*alert_row.values())
        else:
            return DataMetryDataAlert(*alert_row.values())
...
class EtlTestAlert(Alert):
    ...
    def __init__(self, alert_id, detected_at, database_name, schema_name, table_name, column_name, alert_type, sub_type,
        ...
        self.alert_title = "etl test alert"
...
class ElementaryDataAlert(EtlTestAlert):
